...
<template>
  <section id="features" class="relative py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <!-- Bento Grid -->
      <div class="mt-16 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 sm:gap-5">
        <!-- Feature cards -->
        <div
          v-for="(feature, index) in features"
          :key="feature.title"
          :class="[
            'group relative overflow-hidden rounded-2xl border border-surface-800/60 bg-surface-900/50 p-6 transition-all duration-300 hover:border-primary-500/30 hover:bg-surface-900/80 sm:p-8',
        ...
        >
          ...
          <div
            ...
            aria-hidden="true"
          >
            <div class="absolute -top-24 -right-24 h-48 w-48 rounded-full bg-primary-600/10 blur-3xl" />
          </div>
          ...
          <div class="relative">
            ...
            >
              ...
              <div class="flex -space-x-2">
                <div class="h-7 w-7 rounded-full border-2 border-surface-900 bg-surface-700" />
                <div class="h-7 w-7 rounded-full border-2 border-surface-900 bg-surface-600" />
                <div class="h-7 w-7 rounded-full border-2 border-surface-900 bg-surface-500" />
                <div class="flex h-7 w-7 items-center justify-center rounded-full border-2 border-surface-900 bg-primary-600 text-[10px] font-bold text-white">
                  +
                </div>
              </div>
            </div>
